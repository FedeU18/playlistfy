...
import NotFound from "../NotFound/NotFound"; // Ajusta la ruta según tu estructura
...
const AlbumDetail = ({ accessToken }) => {
  ...
  // Mientras ni album ni error estén definidos
  if (!album && !error) {
    return <h1 className="text-white text-center">{t("loading")}</h1>;
  }
  ...
  // Renderizamos el detalle cuando album está disponible
  return (
